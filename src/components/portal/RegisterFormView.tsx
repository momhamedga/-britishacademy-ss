...
export default function RegisterFormView({ formAction, isPending, state, callbackUrl }: RegisterFormViewProps) {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        ...
        <div className="space-y-1.5">
          ...
          <input 
            ...
            className="w-full bg-white/2 border border-white/10 rounded-xl md:rounded-2xl px-5 py-3.5 md:py-4 text-white text-sm outline-none focus:border-gold/40 transition-all font-bold placeholder:text-white/10" 
          />
        </div>
      </div>
