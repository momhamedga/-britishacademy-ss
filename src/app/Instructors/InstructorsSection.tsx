...
// ✅ تعريف الـ Store خارج الكومبوننت لضمان استقرار الـ UI
const subscribe = () => () => {};
const getSnapshot = () => true; 
const getServerSnapshot = () => false;

export default function InstructorsSection() {
  // ✅ الحل القاطع لمنع تضارب رندر السيرفر مع الكلينت (Hydration Safe)
  ...
  return (
    <section className="pb-32 px-4 md:px-6 relative z-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div 
          ref={scrollRef}
          className="flex overflow-x-auto snap-x snap-mandatory no-scrollbar gap-5 pb-12 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-10 md:pb-0"
        >
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-x-3 bottom-3">
                  <div className="glass-jusoor p-6 md:p-10 rounded-[2.5rem] md:rounded-[3.5rem] border border-white/10 backdrop-blur-3xl translate-y-4 group-hover:translate-y-0 transition-all duration-700 relative z-20 overflow-hidden shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
