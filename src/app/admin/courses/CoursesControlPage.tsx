...
export default function CoursesControlPage({ initialCourses }: { initialCourses: any[] }) {
  ...
  return (
    // 🛡️ تم ضبط الـ pt-28 للهروب من الـ Navbar واستبدال الـ background بالفورمات النظيف
    <main className="min-h-screen bg-transparent px-4 md:px-10 pt-28 pb-20 font-sans">
      <AnimatePresence mode="wait">
        {view === 'inventory' ? (
          ...
          >
            {/* Header - تنظيف الـ variables وتأمين ثبات المظهر */}
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 bg-white/40 backdrop-blur-3xl p-8 md:p-12 rounded-[2.5rem] border border-white/60 shadow-[0_20px_50px_rgba(0,0,0,0.02)] relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-4">
                ...
                <div className="flex items-center gap-4">
                  <div className="h-10 md:h-14 w-2 bg-gold rounded-full shadow-[0_0_15px_rgba(212,175,55,0.5)]" />
                  <h1 className="text-5xl md:text-8xl font-black uppercase italic tracking-tighter text-navy leading-none">
                    Inventory
                  </h1>
                </div>
                ...
                <Link href="/admin" className="block">
                  ...
                  >
                    {/* Icon Circle */}
                    <div className="size-8 md:size-10 rounded-full border border-black/5 bg-white shadow-sm flex items-center justify-center group-hover:bg-navy group-hover:text-white transition-all duration-300 text-navy">
              ...
              >
                ...
                <div className="absolute inset-0 bg-white/10 -translate-x-full group-hover:translate-x-0 transition-transform duration-500 skew-x-[15deg]" />
              </button>
            </header>
