  ...
  return (
    <main className="min-h-screen w-full flex items-center justify-center relative overflow-hidden px-4 py-8">
      ...
      <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} className="relative z-10 w-full max-w-[460px]">
        <div className="glass p-8 md:p-14 rounded-[2.5rem] md:rounded-[3.5rem] border border-white/10 bg-black/40 backdrop-blur-3xl shadow-2xl overflow-hidden">
          ...
          <div className="mt-12 pt-8 border-t border-white/5 text-center">
            <p className="text-[8px] text-slate-700 font-bold tracking-[0.6em] uppercase opacity-50 italic">
